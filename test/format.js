...
describe('format', function() {
  ...
  it('should format a parsed urn to a string', function() {
    expect(format(null, components, separator, { protocol: protocol, nid: 'i', nss: 's' })).toEqual('urn:i:s');
  });
  it('should format a long urn', function() {
    expect(format(null, [ 'a', 'b', 'c', 'd', 'e', 'f', 'g' ], separator, { protocol: protocol, a: 'a', b: 'b', c: 'c', d: 'd', e: 'e', f: 'f', g: 'g' })).toEqual('urn:a:b:c:d:e:f:g');
  });
  it('should default to empty strings for missing or invalid', function() {
    expect(format(null, [ 'a', 'b', 'c', 'd', 'e', 'f', 'g' ], separator, { protocol: protocol, a: 'a', g: 'g' })).toEqual('urn:a::::::g');
  });
  ...
  it('should allow protocol to be overwritten in the supplied parsed object', function() {
    ...
    expect(format('blah', components, separator, { protocol: protocol, nid: 'i', nss: 's' })).toEqual('urn:i:s');
  });
});
