...
### `3.0.0`
- Nothing significant changes to public API
- Updated project to ESM and now shipping both CJS and ESM bundles
- Dropped testing for old versions of node. Minimum tested version is now Node v18
